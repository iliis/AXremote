...
_pkts_missing::
	.ds 2
Lmain.axradio_statuschange$rssi_ratelimit$1$208==.
_axradio_statuschange_rssi_ratelimit_1_208:
	.ds 2
Lmain.axradio_statuschange$foffs$3$217==.
_axradio_statuschange_foffs_3_217:
	.ds 4
;--------------------------------------------------------
...
;--------------------------------------------------------
	...
	C$main.c$79$3$251 ==.
;	main.c:79: uint8_t __data coldstart = 1; // caution: initialization with 1 is necessary! Variables are initialized upon _sdcc_external_startup returning 0 -> the coldstart value returned from _sdcc_external startup does not survive in the coldstart case
	mov	_coldstart,#0x01
	C$main.c$80$3$251 ==.
;	main.c:80: uint16_t __data pkts_received = 0, pkts_missing = 0;
	clr	a
	mov	_pkts_received,a
	mov	(_pkts_received + 1),a
	C$main.c$80$3$251 ==.
;	main.c:80: 
	clr	a
	mov	_pkts_missing,a
...
;------------------------------------------------------------
	...
	C$main.c$82$0$0 ==.
;	main.c:82: static void pwrmgmt_irq(void) __interrupt(INT_POWERMGMT)
;	-----------------------------------------
...
_pwrmgmt_irq:
	...
	mov	psw,#0x00
	C$main.c$84$1$0 ==.
;	main.c:84: uint8_t pc = PCON;
	C$main.c$85$1$206 ==.
;	main.c:85: if (!(pc & 0x80))
	mov	a,_PCON
	mov	r7,a
	jb	acc.7,00102$
	C$main.c$86$1$206 ==.
...
00102$:
	C$main.c$87$1$206 ==.
;	main.c:87: GPIOENABLE = 0;
	mov	dptr,#_GPIOENABLE
	clr	a
	movx	@dptr,a
	C$main.c$88$1$206 ==.
;	main.c:88: IE = EIE = E2IE = 0;
	mov	_E2IE,#0x00
	mov	_EIE,#0x00
	mov	_IE,#0x00
00104$:
...
;------------------------------------------------------------
;rssi_ratelimit            Allocated with name '_axradio_statuschange_rssi_ratelimit_1_208'
;st                        Allocated to registers r6 r7 
;retran                    Allocated to registers 
;foffs                     Allocated with name '_axradio_statuschange_foffs_3_217'
;fcorr                     Allocated to registers r4 r5 
;------------------------------------------------------------
	G$axradio_statuschange$0$0 ==.
	C$main.c$93$1$206 ==.
;	main.c:93: void axradio_statuschange(struct axradio_status __xdata *st)
;	-----------------------------------------
...
_axradio_statuschange:
	...
	mov	r7,dph
	C$main.c$97$1$208 ==.
;	main.c:97: if (DBGLNKSTAT & 0x10 && st->status != AXRADIO_STAT_CHANNELSTATE) {
	mov	a,_DBGLNKSTAT
	jnb	acc.4,00102$
	mov	dpl,r6
	mov	dph,r7
...
00162$:
	C$main.c$98$2$209 ==.
;	main.c:98: dbglink_writestr("ST: 0x");
	mov	dptr,#__str_0
	mov	b,#0x80
	push	ar7
	push	ar6
	...
	pop	ar7
	C$main.c$99$2$209 ==.
;	main.c:99: dbglink_writehex16(st->status, 2, WRNUM_PADZERO);
	mov	dpl,r6
	mov	dph,r7
	movx	a,@dptr
	mov	r5,a
	...
	dec	sp
	C$main.c$100$2$209 ==.
;	main.c:100: dbglink_writestr(" ERR: 0x");
	mov	dptr,#__str_1
	mov	b,#0x80
	lcall	_dbglink_writestr
	pop	ar6
	pop	ar7
	C$main.c$101$2$209 ==.
;	main.c:101: dbglink_writehex16(st->error, 2, WRNUM_PADZERO);
	mov	dpl,r6
	mov	dph,r7
	inc	dptr
	movx	a,@dptr
	...
	pop	ar7
	C$main.c$102$2$209 ==.
;	main.c:102: dbglink_tx('\n');
	mov	dpl,#0x0A
	lcall	_dbglink_tx
00102$:
	C$main.c$105$1$208 ==.
;	main.c:105: switch (st->status) {
	mov	dpl,r6
	mov	dph,r7
	movx	a,@dptr
	mov	r5,a
...
00164$:
	ljmp	00144$
	C$main.c$106$2$210 ==.
;	main.c:106: case AXRADIO_STAT_RECEIVE:
00104$:
	C$main.c$156$3$211 ==.
;	main.c:156: ++pkts_received;
	inc	_pkts_received
	clr	a
	cjne	a,_pkts_received,00166$
	inc	(_pkts_received + 1)
00166$:
	C$main.c$157$4$212 ==.
...
;	main.c:170: if (st->error == AXRADIO_ERR_NOERROR)
	...
	jnz	00122$
	C$main.c$171$2$210 ==.
;	main.c:171: dbglink_received_packet(st);
	mov	dpl,r6
	mov	dph,r7
	push	ar7
	push	ar6
...
00122$:
	C$main.c$175$3$217 ==.
;	main.c:175: int32_t foffs = axradio_get_freqoffset();
	push	ar7
	push	ar6
	lcall	_axradio_get_freqoffset
	mov	_axradio_statuschange_foffs_3_217,dpl
	mov	(_axradio_statuschange_foffs_3_217 + 1),dph
	mov	(_axradio_statuschange_foffs_3_217 + 2),b
	mov	(_axradio_statuschange_foffs_3_217 + 3),a
	pop	ar6
	pop	ar7
	C$main.c$182$4$218 ==.
;	main.c:182: if (labs(st->u.rx.phy.offset) > 2000)
	mov	a,#0x06
	add	a,r6
	mov	r6,a
	clr	a
...
00125$:
	C$main.c$186$4$218 ==.
;	main.c:186: if (st->u.rx.phy.offset < 0)
	mov	dpl,r6
	mov	dph,r7
	movx	a,@dptr
	mov	r6,a
...
00127$:
	C$main.c$188$4$218 ==.
;	main.c:188: foffs -= fcorr;
	mov	a,r5
	rlc	a
	subb	a,acc
	mov	r7,a
	mov	r6,a
	mov	a,_axradio_statuschange_foffs_3_217
	clr	c
	subb	a,r4
	mov	_axradio_statuschange_foffs_3_217,a
	mov	a,(_axradio_statuschange_foffs_3_217 + 1)
	subb	a,r5
	mov	(_axradio_statuschange_foffs_3_217 + 1),a
	mov	a,(_axradio_statuschange_foffs_3_217 + 2)
	subb	a,r7
	mov	(_axradio_statuschange_foffs_3_217 + 2),a
	mov	a,(_axradio_statuschange_foffs_3_217 + 3)
	subb	a,r6
	C$main.c$192$3$217 ==.
;	main.c:192: if (axradio_set_freqoffset(foffs) != AXRADIO_ERR_NOERROR)
	mov	(_axradio_statuschange_foffs_3_217 + 3),a
	mov	dpl,_axradio_statuschange_foffs_3_217
	mov	dph,(_axradio_statuschange_foffs_3_217 + 1)
	mov	b,(_axradio_statuschange_foffs_3_217 + 2)
	lcall	_axradio_set_freqoffset
	mov	a,dpl
	jz	00144$
	C$main.c$193$3$217 ==.
;	main.c:193: axradio_set_freqoffset(0);
...
__sdcc_external_startup:
	C$main.c$250$1$224 ==.
;	main.c:250: LPXOSCGM = 0x8A;
	mov	dptr,#_LPXOSCGM
	mov	a,#0x8A
	movx	@dptr,a
	C$main.c$251$2$225 ==.
;	main.c:251: wtimer0_setclksrc(WTIMER0_CLKSRC, WTIMER0_PRESCALER);
	mov	dpl,#0x09
	lcall	_wtimer0_setconfig
	C$main.c$252$2$226 ==.
;	main.c:252: wtimer1_setclksrc(CLKSRC_FRCOSC, 7);
	mov	dpl,#0x38
...
;	main.c:257: ANALOGA = 0x18; // PA[3,4] LPXOSC, other PA are used as digital pins
	...
	movx	@dptr,a
	C$main.c$269$1$224 ==.
;	main.c:269: PORTA = 0xFF; //
	mov	_PORTA,#0xFF
	C$main.c$270$1$224 ==.
;	main.c:270: PORTB = 0xFD | (PINB & 0x02); //
	mov	a,#0x02
	anl	a,_PINB
	orl	a,#0xFD
	mov	_PORTB,a
	C$main.c$271$1$224 ==.
;	main.c:271: PORTC = 0xFF; //
	mov	_PORTC,#0xFF
	C$main.c$272$1$224 ==.
;	main.c:272: PORTR = 0xCB; //
	mov	_PORTR,#0xCB
	C$main.c$274$1$224 ==.
;	main.c:274: DIRA = 0x00; //
	mov	_DIRA,#0x00
	C$main.c$275$1$224 ==.
;	main.c:275: DIRB = 0x06; //  PB1 = LED, PB2 = TCXO ON/OFF
	mov	_DIRB,#0x06
	C$main.c$276$1$224 ==.
;	main.c:276: DIRC = 0x00; //  PC4 = Switch
	mov	_DIRC,#0x00
	C$main.c$277$1$224 ==.
;	main.c:277: DIRR = 0x15; //
	mov	_DIRR,#0x15
	C$main.c$278$1$224 ==.
;	main.c:278: PALTRADIO |= (1<<6);
	mov	dptr,#_PALTRADIO
	movx	a,@dptr
	mov	r7,a
	orl	a,#0x40
...
;	main.c:283: EIE = 0x00;
	mov	_EIE,#0x00
	C$main.c$284$1$224 ==.
;	main.c:284: E2IE = 0x00;
	mov	_E2IE,#0x00
	C$main.c$286$1$224 ==.
;	main.c:286: GPIOENABLE = 1; // unfreeze GPIO
	mov	dptr,#_GPIOENABLE
	mov	a,#0x01
	movx	@dptr,a
	C$main.c$290$1$224 ==.
;	main.c:290: return !coldstart; // coldstart -> return 0 -> var initialization; start from sleep -> return 1 -> no var initialization
	mov	a,_coldstart
	cjne	a,#0x01,00112$
00112$:
	clr	a
...
;	main.c:307: __endasm;
	...
	C$main.c$311$1$229 ==.
;	main.c:311: dbglink_init();
	lcall	_dbglink_init
	C$main.c$314$1$229 ==.
;	main.c:314: EA = 1;
	setb	_EA
	C$main.c$315$1$229 ==.
;	main.c:315: flash_apply_calibration();
	lcall	_flash_apply_calibration
	C$main.c$316$1$229 ==.
;	main.c:316: CLKCON = 0x00;
	mov	_CLKCON,#0x00
	C$main.c$317$1$229 ==.
;	main.c:317: wtimer_init();
	lcall	_wtimer_init
	C$main.c$319$1$229 ==.
...
;	main.c:337: dbglink_writestr("error initializing radio: ");
	...
	pop	ar7
	C$main.c$338$3$241 ==.
;	main.c:338: dbglink_writehexu16(i, 2);
	mov	ar5,r7
	mov	r6,#0x00
	push	ar7
	mov	a,#0x02
...
;	main.c:348: axradio_set_local_address(&localaddr);
	...
	C$main.c$349$2$230 ==.
;	main.c:349: axradio_set_default_remote_address(&remoteaddr);
...
;	main.c:378: dbglink_writestr("RNG = ");
	...
	lcall	_dbglink_writestr
	C$main.c$379$3$245 ==.
;	main.c:379: dbglink_writenum16(axradio_get_pllrange(), 2, 0);
...
;	main.c:423: EA = 0;
	clr	_EA
	C$main.c$425$3$248 ==.
;	main.c:425: uint8_t flg = WTFLAG_CANSTANDBY;
	mov	r6,#0x02
	C$main.c$427$3$249 ==.
;	main.c:427: if (axradio_cansleep()
	push	ar6
...
;	main.c:448: wtimer_runcallbacks();
	lcall	_wtimer_runcallbacks
	C$main.c$450$3$250 ==.
;	main.c:450: uint8_t flg = WTFLAG_CANSTANDBY;
	mov	r7,#0x02
	C$main.c$452$3$251 ==.
;	main.c:452: if (axradio_cansleep()
	push	ar7
	lcall	_axradio_cansleep
	mov	a,dpl
	pop	ar7
