...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'wait_n_lposccycles'
;------------------------------------------------------------
;n                         Allocated to registers r7 
;cnt                       Allocated to registers r6 
;------------------------------------------------------------
	Flposc$wait_n_lposccycles$0$0 ==.
	C$lposc.c$37$0$0 ==.
;	lposc.c:37: static void wait_n_lposccycles(uint8_t n)
;	-----------------------------------------
;	 function wait_n_lposccycles
;	-----------------------------------------
_wait_n_lposccycles:
	ar7 = 0x07
	ar6 = 0x06
	...
	mov	r7,dpl
	C$lposc.c$40$1$64 ==.
;	lposc.c:40: EA = 0; // isr is not handling lposc irq
	clr	_EA
	C$lposc.c$41$1$64 ==.
;	lposc.c:41: AX5043_IRQMASK1 |= 0x04; // LPOSC irq
...
00106$:
	C$lposc.c$44$2$65 ==.
;	lposc.c:44: if( AX5043_IRQREQUEST1 & 0x04 )
...
;	lposc.c:46: cnt++;
	inc	r6
	C$lposc.c$47$3$66 ==.
;	lposc.c:47: AX5043_LPOSCSTATUS; // clear irq request
	mov	dptr,#_AX5043_LPOSCSTATUS
	movx	a,@dptr
00102$:
	C$lposc.c$50$2$65 ==.
;	lposc.c:50: if(cnt > n)
	...
	jc	00107$
	C$lposc.c$52$2$65 ==.
;	lposc.c:52: enter_standby();
	lcall	_enter_standby
	sjmp	00106$
00107$:
	C$lposc.c$55$1$64 ==.
;	lposc.c:55: AX5043_IRQMASK1 &= ~0x04; // disable LPOSC irq
	mov	dptr,#_AX5043_IRQMASK1
	movx	a,@dptr
	anl	a,#0xFB
	movx	@dptr,a
...
;	lposc.c:56: EA = 1;
	setb	_EA
	C$lposc.c$57$1$64 ==.
	XFlposc$wait_n_lposccycles$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'calibrate_lposc'
;------------------------------------------------------------
;x                         Allocated to registers r7 
;------------------------------------------------------------
	G$calibrate_lposc$0$0 ==.
	C$lposc.c$59$1$64 ==.
;	lposc.c:59: void calibrate_lposc(void)
;	-----------------------------------------
;	 function calibrate_lposc
;	-----------------------------------------
_calibrate_lposc:
	C$lposc.c$61$1$68 ==.
;	lposc.c:61: AX5043_LPOSCFREQ1 = 0x00;
	mov	dptr,#_AX5043_LPOSCFREQ1
	C$lposc.c$62$1$68 ==.
;	lposc.c:62: AX5043_LPOSCFREQ0 = 0x00;
	clr	a
	movx	@dptr,a
	mov	dptr,#_AX5043_LPOSCFREQ0
	movx	@dptr,a
	C$lposc.c$64$1$68 ==.
;	lposc.c:64: AX5043_LPOSCREF1 = ((FXTAL/640)>>8) & 0xFF;
	mov	dptr,#_AX5043_LPOSCREF1
	mov	a,#0x24
	movx	@dptr,a
	C$lposc.c$65$1$68 ==.
;	lposc.c:65: AX5043_LPOSCREF0 = ((FXTAL/640)>>0) & 0xFF;
	mov	dptr,#_AX5043_LPOSCREF0
	mov	a,#0xF8
	movx	@dptr,a
	C$lposc.c$66$1$68 ==.
;	lposc.c:66: AX5043_PWRMODE = AX5043_PWRSTATE_SYNTH_RX;
	mov	dptr,#_AX5043_PWRMODE
	mov	a,#0x08
	movx	@dptr,a
	C$lposc.c$67$1$68 ==.
;	lposc.c:67: AX5043_LPOSCKFILT1 = (lposckfiltmax >> (8 + 1)) & 0xFF; // kfiltmax >> 1
	mov	dptr,#_lposckfiltmax
	clr	a
	movc	a,@a+dptr
	mov	r6,a
	mov	a,#0x01
	...
	rrc	a
	mov	r4,a
	mov	dptr,#_AX5043_LPOSCKFILT1
	mov	a,r4
	movx	@dptr,a
	C$lposc.c$68$1$68 ==.
;	lposc.c:68: AX5043_LPOSCKFILT0 = (lposckfiltmax >> 1) & 0xFF;
	mov	a,r7
	clr	c
	rrc	a
	xch	a,r6
	rrc	a
	xch	a,r6
	mov	dptr,#_AX5043_LPOSCKFILT0
	mov	a,r6
	movx	@dptr,a
	C$lposc.c$69$1$68 ==.
;	lposc.c:69: axradio_wait_for_xtal();
	lcall	_axradio_wait_for_xtal
	C$lposc.c$71$1$68 ==.
;	lposc.c:71: AX5043_LPOSCCONFIG =  0x25; // LPOSC ENA, slow mode; calibrate on rising edge, irq on rising edge
	mov	dptr,#_AX5043_LPOSCCONFIG
	mov	a,#0x25
	movx	@dptr,a
	C$lposc.c$72$1$68 ==.
;	lposc.c:72: wait_n_lposccycles(6);
	mov	dpl,#0x06
	lcall	_wait_n_lposccycles
	C$lposc.c$75$1$68 ==.
;	lposc.c:75: if( AX5043_LPOSCFREQ1 == 0x7F)
	mov	dptr,#_AX5043_LPOSCFREQ1
	movx	a,@dptr
	mov	r7,a
	cjne	r7,#0x7F,00102$
	C$lposc.c$78$2$69 ==.
;	lposc.c:78: AX5043_LPOSCFREQ1 = 0xBC;
	mov	dptr,#_AX5043_LPOSCFREQ1
	mov	a,#0xBC
	movx	@dptr,a
	C$lposc.c$79$2$69 ==.
;	lposc.c:79: wait_n_lposccycles(6);
	mov	dpl,#0x06
	lcall	_wait_n_lposccycles
00102$:
	C$lposc.c$82$1$68 ==.
;	lposc.c:82: if( AX5043_LPOSCFREQ1 == 0x80)
	mov	dptr,#_AX5043_LPOSCFREQ1
	movx	a,@dptr
	mov	r7,a
	cjne	r7,#0x80,00104$
	C$lposc.c$85$2$70 ==.
;	lposc.c:85: AX5043_LPOSCFREQ1 = 0xA8;
	mov	dptr,#_AX5043_LPOSCFREQ1
	mov	a,#0xA8
	movx	@dptr,a
	C$lposc.c$86$2$70 ==.
;	lposc.c:86: wait_n_lposccycles(6);
	mov	dpl,#0x06
	lcall	_wait_n_lposccycles
00104$:
	C$lposc.c$90$1$68 ==.
;	lposc.c:90: AX5043_LPOSCKFILT1 = (lposckfiltmax >> (8 + 2)) & 0xFF; // kfiltmax >> 2
	mov	dptr,#_lposckfiltmax
	clr	a
	movc	a,@a+dptr
	mov	r6,a
	...
	movx	@dptr,a
	C$lposc.c$91$1$68 ==.
;	lposc.c:91: AX5043_LPOSCKFILT0 = (lposckfiltmax >> 2) & 0xFF;
	mov	a,r7
	clr	c
	rrc	a
	xch	a,r6
	...
	movx	@dptr,a
	C$lposc.c$92$1$68 ==.
;	lposc.c:92: wait_n_lposccycles(5);
	mov	dpl,#0x05
	lcall	_wait_n_lposccycles
	C$lposc.c$94$1$68 ==.
;	lposc.c:94: AX5043_LPOSCCONFIG = 0x00;
	mov	dptr,#_AX5043_LPOSCCONFIG
	C$lposc.c$95$1$68 ==.
;	lposc.c:95: AX5043_PWRMODE = AX5043_PWRSTATE_POWERDOWN;
	clr	a
	movx	@dptr,a
	mov	dptr,#_AX5043_PWRMODE
	movx	@dptr,a
	C$lposc.c$98$2$68 ==.
;	lposc.c:98: uint8_t x = AX5043_LPOSCFREQ1;
	mov	dptr,#_AX5043_LPOSCFREQ1
	movx	a,@dptr
	mov	r7,a
	C$lposc.c$99$2$71 ==.
;	lposc.c:99: if( x == 0x7f || x == 0x80 )
	cjne	r7,#0x7F,00120$
	sjmp	00105$
00120$:
	cjne	r7,#0x80,00108$
00105$:
	C$lposc.c$101$3$72 ==.
;	lposc.c:101: AX5043_LPOSCFREQ1 = 0;
	mov	dptr,#_AX5043_LPOSCFREQ1
	C$lposc.c$102$3$72 ==.
;	lposc.c:102: AX5043_LPOSCFREQ0 = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#_AX5043_LPOSCFREQ0
	movx	@dptr,a
