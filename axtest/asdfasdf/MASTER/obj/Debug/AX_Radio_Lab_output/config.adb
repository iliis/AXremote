...
S:Lconfig.axradio_byteconv$b$1$92({1}SC:U),R,0,0,[r7]
F:G$axradio_byteconv_buffer$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lconfig.axradio_byteconv_buffer$buflen$1$94({2}SI:U),B,1,-4
S:Lconfig.axradio_byteconv_buffer$buf$1$94({2}DX,SC:U),R,0,0,[]
F:G$axradio_framing_check_crc$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lconfig.axradio_framing_check_crc$cnt$1$96({2}SI:U),B,1,-4
S:Lconfig.axradio_framing_check_crc$pkt$1$96({2}DX,SC:U),R,0,0,[r6,r7]
F:G$axradio_framing_append_crc$0$0({2}DF,SI:U),Z,0,0,0,0,0
S:Lconfig.axradio_framing_append_crc$cnt$1$98({2}SI:U),B,1,-4
S:Lconfig.axradio_framing_append_crc$pkt$1$98({2}DX,SC:U),R,0,0,[r6,r7]
S:Lconfig.axradio_framing_append_crc$s$1$99({2}SI:U),R,0,0,[r4,r5]
...
S:Lconfig.axradio_conv_freq_fromhz$f$1$86({4}SL:S),R,0,0,[r4,r5,r6,r7]
S:Lconfig.axradio_conv_freq_fromhz$r$1$87({4}SL:S),R,0,0,[r0,r1,r2,r3]
S:Lconfig.axradio_conv_freq_tohz$f$1$88({4}SL:S),R,0,0,[r4,r5,r6,r7]
S:Lconfig.axradio_conv_freq_tohz$r$1$89({4}SL:S),R,0,0,[r0,r1,r2,r3]
S:Lconfig.axradio_conv_timeinterval_totimer0$dt$1$90({4}SL:S),R,0,0,[r4,r5,r6,r7]
S:Lconfig.axradio_conv_timeinterval_totimer0$r$1$91({4}SL:S),R,0,0,[r0,r1,r2,r3]
