...
; This file was generated Sat Dec 21 21:55:18 2013
;--------------------------------------------------------
	.module config
...
;	..\AX_Radio_Lab_output\config.c:18: AX5043_PINFUNCDATA             = 0x01;
	...
	movx	@dptr,a
	C$config.c$19$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:19: AX5043_PINFUNCANTSEL           = 0x01;
	mov	dptr,#_AX5043_PINFUNCANTSEL
	mov	a,#0x01
	movx	@dptr,a
	C$config.c$20$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:20: AX5043_PINFUNCPWRAMP           = 0x07;
...
;	..\AX_Radio_Lab_output\config.c:21: AX5043_WAKEUPXOEARLY           = 0x01;
	...
	movx	@dptr,a
	C$config.c$22$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:22: AX5043_IFFREQ1                 = 0x03;
	mov	dptr,#_AX5043_IFFREQ1
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$23$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:23: AX5043_IFFREQ0                 = 0x33;
	mov	dptr,#_AX5043_IFFREQ0
	mov	a,#0x33
	movx	@dptr,a
	C$config.c$24$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:24: AX5043_DECIMATION              = 0x13;
...
;	..\AX_Radio_Lab_output\config.c:25: AX5043_RXDATARATE2             = 0x00;
	...
	movx	@dptr,a
	C$config.c$26$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:26: AX5043_RXDATARATE1             = 0x57;
	mov	dptr,#_AX5043_RXDATARATE1
	mov	a,#0x57
	movx	@dptr,a
	C$config.c$27$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:27: AX5043_RXDATARATE0             = 0xB8;
...
;	..\AX_Radio_Lab_output\config.c:31: AX5043_MAXRFOFFSET2            = 0x80;
	...
	movx	@dptr,a
	C$config.c$32$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:32: AX5043_MAXRFOFFSET1            = 0x47;
	mov	dptr,#_AX5043_MAXRFOFFSET1
	mov	a,#0x47
	movx	@dptr,a
	C$config.c$33$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:33: AX5043_MAXRFOFFSET0            = 0x22;
	mov	dptr,#_AX5043_MAXRFOFFSET0
	mov	a,#0x22
	movx	@dptr,a
	C$config.c$34$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:34: AX5043_FSKDMAX1                = 0x01;
	mov	dptr,#_AX5043_FSKDMAX1
	mov	a,#0x01
	movx	@dptr,a
	C$config.c$35$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:35: AX5043_FSKDMAX0                = 0x56;
	mov	dptr,#_AX5043_FSKDMAX0
	mov	a,#0x56
	movx	@dptr,a
	C$config.c$36$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:36: AX5043_FSKDMIN1                = 0xFE;
	mov	dptr,#_AX5043_FSKDMIN1
	mov	a,#0xFE
	movx	@dptr,a
	C$config.c$37$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:37: AX5043_FSKDMIN0                = 0xAA;
...
;	..\AX_Radio_Lab_output\config.c:39: AX5043_RXPARAMSETS             = 0xF4;
	...
	movx	@dptr,a
	C$config.c$40$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:40: AX5043_AGCGAIN0                = 0x96;
	mov	dptr,#_AX5043_AGCGAIN0
	mov	a,#0x96
	movx	@dptr,a
	C$config.c$41$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:41: AX5043_AGCTARGET0              = 0x76;
	mov	dptr,#_AX5043_AGCTARGET0
	mov	a,#0x76
	movx	@dptr,a
	C$config.c$42$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:42: AX5043_TIMEGAIN0               = 0xA9;
	mov	dptr,#_AX5043_TIMEGAIN0
	mov	a,#0xA9
	movx	@dptr,a
	C$config.c$43$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:43: AX5043_DRGAIN0                 = 0xB3;
...
;	..\AX_Radio_Lab_output\config.c:46: AX5043_FREQUENCYGAINB0         = 0x1F;
	...
	movx	@dptr,a
	C$config.c$47$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:47: AX5043_FREQUENCYGAINC0         = 0x08;
	mov	dptr,#_AX5043_FREQUENCYGAINC0
	mov	a,#0x08
	movx	@dptr,a
	C$config.c$48$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:48: AX5043_FREQUENCYGAIND0         = 0x08;
	mov	dptr,#_AX5043_FREQUENCYGAIND0
	mov	a,#0x08
	movx	@dptr,a
	C$config.c$49$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:49: AX5043_AMPLITUDEGAIN0          = 0x46;
...
;	..\AX_Radio_Lab_output\config.c:51: AX5043_FREQDEV00               = 0x00;
	C$config.c$52$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:52: AX5043_FOURFSK0                = 0x00;
	C$config.c$53$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:53: AX5043_BBOFFSRES0              = 0x00;
	clr	a
	movx	@dptr,a
	...
	movx	@dptr,a
	C$config.c$54$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:54: AX5043_AGCGAIN1                = 0x96;
	mov	dptr,#_AX5043_AGCGAIN1
	mov	a,#0x96
	movx	@dptr,a
	C$config.c$55$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:55: AX5043_AGCTARGET1              = 0x76;
	mov	dptr,#_AX5043_AGCTARGET1
	mov	a,#0x76
	movx	@dptr,a
	C$config.c$56$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:56: AX5043_AGCAHYST1               = 0x00;
	mov	dptr,#_AX5043_AGCAHYST1
	C$config.c$57$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:57: AX5043_AGCMINMAX1              = 0x00;
	clr	a
	movx	@dptr,a
	mov	dptr,#_AX5043_AGCMINMAX1
	movx	@dptr,a
	C$config.c$58$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:58: AX5043_TIMEGAIN1               = 0xA7;
	mov	dptr,#_AX5043_TIMEGAIN1
	mov	a,#0xA7
	movx	@dptr,a
	C$config.c$59$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:59: AX5043_DRGAIN1                 = 0xB2;
	mov	dptr,#_AX5043_DRGAIN1
	mov	a,#0xB2
	movx	@dptr,a
	C$config.c$60$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:60: AX5043_PHASEGAIN1              = 0xC3;
	mov	dptr,#_AX5043_PHASEGAIN1
	mov	a,#0xC3
	movx	@dptr,a
	C$config.c$61$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:61: AX5043_FREQUENCYGAINA1         = 0x0F;
	mov	dptr,#_AX5043_FREQUENCYGAINA1
	mov	a,#0x0F
	movx	@dptr,a
	C$config.c$62$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:62: AX5043_FREQUENCYGAINB1         = 0x1F;
	mov	dptr,#_AX5043_FREQUENCYGAINB1
	mov	a,#0x1F
	movx	@dptr,a
	C$config.c$63$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:63: AX5043_FREQUENCYGAINC1         = 0x08;
	mov	dptr,#_AX5043_FREQUENCYGAINC1
	mov	a,#0x08
	movx	@dptr,a
	C$config.c$64$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:64: AX5043_FREQUENCYGAIND1         = 0x08;
	mov	dptr,#_AX5043_FREQUENCYGAIND1
	mov	a,#0x08
	movx	@dptr,a
	C$config.c$65$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:65: AX5043_AMPLITUDEGAIN1          = 0x46;
	mov	dptr,#_AX5043_AMPLITUDEGAIN1
	mov	a,#0x46
	movx	@dptr,a
	C$config.c$66$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:66: AX5043_FREQDEV11               = 0x00;
	mov	dptr,#_AX5043_FREQDEV11
	clr	a
	movx	@dptr,a
	C$config.c$67$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:67: AX5043_FREQDEV01               = 0x38;
	mov	dptr,#_AX5043_FREQDEV01
	mov	a,#0x38
	movx	@dptr,a
	C$config.c$68$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:68: AX5043_FOURFSK1                = 0x00;
	mov	dptr,#_AX5043_FOURFSK1
	C$config.c$69$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:69: AX5043_BBOFFSRES1              = 0x00;
	clr	a
	movx	@dptr,a
	mov	dptr,#_AX5043_BBOFFSRES1
	movx	@dptr,a
	C$config.c$70$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:70: AX5043_AGCGAIN3                = 0xFF;
	mov	dptr,#_AX5043_AGCGAIN3
	mov	a,#0xFF
	movx	@dptr,a
	C$config.c$71$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:71: AX5043_AGCTARGET3              = 0x76;
	mov	dptr,#_AX5043_AGCTARGET3
	mov	a,#0x76
	movx	@dptr,a
	C$config.c$72$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:72: AX5043_AGCAHYST3               = 0x00;
	mov	dptr,#_AX5043_AGCAHYST3
	C$config.c$73$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:73: AX5043_AGCMINMAX3              = 0x00;
	clr	a
	movx	@dptr,a
	mov	dptr,#_AX5043_AGCMINMAX3
	movx	@dptr,a
	C$config.c$74$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:74: AX5043_TIMEGAIN3               = 0xA6;
	mov	dptr,#_AX5043_TIMEGAIN3
	mov	a,#0xA6
	movx	@dptr,a
	C$config.c$75$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:75: AX5043_DRGAIN3                 = 0xB1;
	mov	dptr,#_AX5043_DRGAIN3
	mov	a,#0xB1
	movx	@dptr,a
	C$config.c$76$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:76: AX5043_PHASEGAIN3              = 0xC3;
	mov	dptr,#_AX5043_PHASEGAIN3
	mov	a,#0xC3
	movx	@dptr,a
	C$config.c$77$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:77: AX5043_FREQUENCYGAINA3         = 0x0F;
	mov	dptr,#_AX5043_FREQUENCYGAINA3
	mov	a,#0x0F
	movx	@dptr,a
	C$config.c$78$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:78: AX5043_FREQUENCYGAINB3         = 0x1F;
	mov	dptr,#_AX5043_FREQUENCYGAINB3
	mov	a,#0x1F
	movx	@dptr,a
	C$config.c$79$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:79: AX5043_FREQUENCYGAINC3         = 0x0C;
	mov	dptr,#_AX5043_FREQUENCYGAINC3
	mov	a,#0x0C
	movx	@dptr,a
	C$config.c$80$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:80: AX5043_FREQUENCYGAIND3         = 0x0C;
	mov	dptr,#_AX5043_FREQUENCYGAIND3
	mov	a,#0x0C
	movx	@dptr,a
	C$config.c$81$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:81: AX5043_AMPLITUDEGAIN3          = 0x46;
	mov	dptr,#_AX5043_AMPLITUDEGAIN3
	mov	a,#0x46
	movx	@dptr,a
	C$config.c$82$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:82: AX5043_FREQDEV13               = 0x00;
	mov	dptr,#_AX5043_FREQDEV13
	clr	a
	movx	@dptr,a
	C$config.c$83$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:83: AX5043_FREQDEV03               = 0x38;
	mov	dptr,#_AX5043_FREQDEV03
	mov	a,#0x38
	movx	@dptr,a
	C$config.c$84$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:84: AX5043_FOURFSK3                = 0x00;
	mov	dptr,#_AX5043_FOURFSK3
	C$config.c$85$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:85: AX5043_BBOFFSRES3              = 0x00;
	clr	a
	movx	@dptr,a
	mov	dptr,#_AX5043_BBOFFSRES3
	movx	@dptr,a
	C$config.c$86$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:86: AX5043_MODCFGF                 = 0x03;
	mov	dptr,#_AX5043_MODCFGF
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$87$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:87: AX5043_FSKDEV2                 = 0x00;
	mov	dptr,#_AX5043_FSKDEV2
	clr	a
	movx	@dptr,a
	C$config.c$88$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:88: AX5043_FSKDEV1                 = 0xCB;
	mov	dptr,#_AX5043_FSKDEV1
	mov	a,#0xCB
	movx	@dptr,a
	C$config.c$89$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:89: AX5043_FSKDEV0                 = 0x29;
	mov	dptr,#_AX5043_FSKDEV0
	mov	a,#0x29
	movx	@dptr,a
	C$config.c$90$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:90: AX5043_MODCFGA                 = 0x05;
	mov	dptr,#_AX5043_MODCFGA
	mov	a,#0x05
	movx	@dptr,a
	C$config.c$91$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:91: AX5043_TXRATE2                 = 0x00;
	mov	dptr,#_AX5043_TXRATE2
	clr	a
	movx	@dptr,a
	C$config.c$92$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:92: AX5043_TXRATE1                 = 0x13;
	mov	dptr,#_AX5043_TXRATE1
	mov	a,#0x13
	movx	@dptr,a
	C$config.c$93$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:93: AX5043_TXRATE0                 = 0xA9;
	mov	dptr,#_AX5043_TXRATE0
	mov	a,#0xA9
	movx	@dptr,a
	C$config.c$94$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:94: AX5043_TXPWRCOEFFB1            = 0x0F;
	mov	dptr,#_AX5043_TXPWRCOEFFB1
	mov	a,#0x0F
	movx	@dptr,a
	C$config.c$95$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:95: AX5043_TXPWRCOEFFB0            = 0xFF;
	mov	dptr,#_AX5043_TXPWRCOEFFB0
	mov	a,#0xFF
	movx	@dptr,a
	C$config.c$96$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:96: AX5043_PLLRNGCLK               = 0x03;
	mov	dptr,#_AX5043_PLLRNGCLK
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$97$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:97: AX5043_BBTUNE                  = 0x0F;
...
;	..\AX_Radio_Lab_output\config.c:112: AX5043_MATCH1MAX               = 0x0A;
	...
	movx	@dptr,a
	C$config.c$113$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:113: AX5043_TMGRXBOOST              = 0x32;
	mov	dptr,#_AX5043_TMGRXBOOST
	mov	a,#0x32
	movx	@dptr,a
	C$config.c$114$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:114: AX5043_TMGRXSETTLE             = 0x14;
	mov	dptr,#_AX5043_TMGRXSETTLE
	mov	a,#0x14
	movx	@dptr,a
	C$config.c$115$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:115: AX5043_TMGRXOFFSACQ            = 0x73;
	mov	dptr,#_AX5043_TMGRXOFFSACQ
	mov	a,#0x73
	movx	@dptr,a
	C$config.c$116$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:116: AX5043_TMGRXCOARSEAGC          = 0x0C;
	mov	dptr,#_AX5043_TMGRXCOARSEAGC
	mov	a,#0x0C
	movx	@dptr,a
	C$config.c$117$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:117: AX5043_TMGRXAGC                = 0x00;
	mov	dptr,#_AX5043_TMGRXAGC
	clr	a
	movx	@dptr,a
	C$config.c$118$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:118: AX5043_TMGRXRSSI               = 0x08;
	mov	dptr,#_AX5043_TMGRXRSSI
	mov	a,#0x08
	movx	@dptr,a
	C$config.c$119$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:119: AX5043_TMGRXPREAMBLE2          = 0x35;
	mov	dptr,#_AX5043_TMGRXPREAMBLE2
	mov	a,#0x35
	movx	@dptr,a
	C$config.c$120$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:120: AX5043_RSSIREFERENCE           = 0x19;
	mov	dptr,#_AX5043_RSSIREFERENCE
	mov	a,#0x19
	movx	@dptr,a
	C$config.c$121$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:121: AX5043_RSSIABSTHR              = 0xC6;
	mov	dptr,#_AX5043_RSSIABSTHR
	mov	a,#0xC6
	movx	@dptr,a
	C$config.c$122$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:122: AX5043_BGNDRSSIGAIN            = 0x02;
	mov	dptr,#_AX5043_BGNDRSSIGAIN
	mov	a,#0x02
	movx	@dptr,a
	C$config.c$123$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:123: AX5043_BGNDRSSITHR             = 0x00;
	mov	dptr,#_AX5043_BGNDRSSITHR
	clr	a
	movx	@dptr,a
	C$config.c$124$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:124: AX5043_PKTCHUNKSIZE            = 0x0D;
	mov	dptr,#_AX5043_PKTCHUNKSIZE
	mov	a,#0x0D
	movx	@dptr,a
	C$config.c$125$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:125: AX5043_PKTMISCFLAGS            = 0x03;
	mov	dptr,#_AX5043_PKTMISCFLAGS
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$126$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:126: AX5043_PKTACCEPTFLAGS          = 0x20;
	mov	dptr,#_AX5043_PKTACCEPTFLAGS
	mov	a,#0x20
	movx	@dptr,a
	C$config.c$127$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:127: AX5043_DACVALUE1               = 0x00;
	mov	dptr,#_AX5043_DACVALUE1
	C$config.c$128$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:128: AX5043_DACVALUE0               = 0x00;
	C$config.c$129$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:129: AX5043_DACCONFIG               = 0x00;
	clr	a
	movx	@dptr,a
	...
	movx	@dptr,a
	C$config.c$130$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:130: AX5043_0xF10                   = 0x03;
	mov	dptr,#_AX5043_0xF10
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$131$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:131: AX5043_0xF11                   = 0x07;
	mov	dptr,#_AX5043_0xF11
	mov	a,#0x07
	movx	@dptr,a
	C$config.c$132$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:132: AX5043_0xF1C                   = 0x07;
	mov	dptr,#_AX5043_0xF1C
	mov	a,#0x07
	movx	@dptr,a
	C$config.c$133$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:133: AX5043_0xF21                   = 0x5C;
	mov	dptr,#_AX5043_0xF21
	mov	a,#0x5C
	movx	@dptr,a
	C$config.c$134$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:134: AX5043_0xF22                   = 0x53;
	mov	dptr,#_AX5043_0xF22
	mov	a,#0x53
	movx	@dptr,a
	C$config.c$135$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:135: AX5043_0xF23                   = 0x76;
	mov	dptr,#_AX5043_0xF23
	mov	a,#0x76
	movx	@dptr,a
	C$config.c$136$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:136: AX5043_0xF26                   = 0x92;
	mov	dptr,#_AX5043_0xF26
	mov	a,#0x92
	movx	@dptr,a
	C$config.c$137$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:137: AX5043_0xF34                   = 0x08;
	mov	dptr,#_AX5043_0xF34
	mov	a,#0x08
	movx	@dptr,a
	C$config.c$138$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:138: AX5043_0xF35                   = 0x10;
	mov	dptr,#_AX5043_0xF35
	mov	a,#0x10
	movx	@dptr,a
	C$config.c$139$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:139: AX5043_0xF44                   = 0x24;
...
;------------------------------------------------------------
	...
	C$config.c$143$1$81 ==.
;	..\AX_Radio_Lab_output\config.c:143: __reentrantb void ax5043_set_registers_tx(void) __reentrant
;	-----------------------------------------
;	 function ax5043_set_registers_tx
;	-----------------------------------------
_ax5043_set_registers_tx:
	C$config.c$145$1$83 ==.
;	..\AX_Radio_Lab_output\config.c:145: AX5043_PLLLOOP                 = 0x09;
	mov	dptr,#_AX5043_PLLLOOP
	mov	a,#0x09
	movx	@dptr,a
	C$config.c$146$1$83 ==.
;	..\AX_Radio_Lab_output\config.c:146: AX5043_PLLCPI                  = 0x02;
	mov	dptr,#_AX5043_PLLCPI
	mov	a,#0x02
	movx	@dptr,a
	C$config.c$147$1$83 ==.
;	..\AX_Radio_Lab_output\config.c:147: AX5043_PLLVCODIV               = 0x20;
	mov	dptr,#_AX5043_PLLVCODIV
	mov	a,#0x20
	movx	@dptr,a
	C$config.c$148$1$83 ==.
;	..\AX_Radio_Lab_output\config.c:148: AX5043_PLLVCOI                 = 0x99;
	mov	dptr,#_AX5043_PLLVCOI
	mov	a,#0x99
	movx	@dptr,a
	C$config.c$149$1$83 ==.
;	..\AX_Radio_Lab_output\config.c:149: AX5043_XTALCAP                 = 0x0C;
	mov	dptr,#_AX5043_XTALCAP
	mov	a,#0x0C
	movx	@dptr,a
	C$config.c$150$1$83 ==.
;	..\AX_Radio_Lab_output\config.c:150: AX5043_0xF00                   = 0x0F;
	mov	dptr,#_AX5043_0xF00
	mov	a,#0x0F
	movx	@dptr,a
	C$config.c$151$1$83 ==.
;	..\AX_Radio_Lab_output\config.c:151: AX5043_REF                     = 0x03;
	mov	dptr,#_AX5043_REF
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$152$1$83 ==.
;	..\AX_Radio_Lab_output\config.c:152: AX5043_0xF18                   = 0x06;
...
;------------------------------------------------------------
	...
	C$config.c$156$1$83 ==.
;	..\AX_Radio_Lab_output\config.c:156: __reentrantb void ax5043_set_registers_rx(void) __reentrant
;	-----------------------------------------
;	 function ax5043_set_registers_rx
;	-----------------------------------------
_ax5043_set_registers_rx:
	C$config.c$158$1$85 ==.
;	..\AX_Radio_Lab_output\config.c:158: AX5043_PLLLOOP                 = 0x07;
	mov	dptr,#_AX5043_PLLLOOP
	mov	a,#0x07
	movx	@dptr,a
	C$config.c$159$1$85 ==.
;	..\AX_Radio_Lab_output\config.c:159: AX5043_PLLCPI                  = 0x08;
	mov	dptr,#_AX5043_PLLCPI
	mov	a,#0x08
	movx	@dptr,a
	C$config.c$160$1$85 ==.
;	..\AX_Radio_Lab_output\config.c:160: AX5043_PLLVCODIV               = 0x20;
	mov	dptr,#_AX5043_PLLVCODIV
	mov	a,#0x20
	movx	@dptr,a
	C$config.c$161$1$85 ==.
;	..\AX_Radio_Lab_output\config.c:161: AX5043_PLLVCOI                 = 0x99;
	mov	dptr,#_AX5043_PLLVCOI
	mov	a,#0x99
	movx	@dptr,a
	C$config.c$162$1$85 ==.
;	..\AX_Radio_Lab_output\config.c:162: AX5043_XTALCAP                 = 0x0C;
	mov	dptr,#_AX5043_XTALCAP
	mov	a,#0x0C
	movx	@dptr,a
	C$config.c$163$1$85 ==.
;	..\AX_Radio_Lab_output\config.c:163: AX5043_0xF00                   = 0x0F;
	mov	dptr,#_AX5043_0xF00
	mov	a,#0x0F
	movx	@dptr,a
	C$config.c$164$1$85 ==.
;	..\AX_Radio_Lab_output\config.c:164: AX5043_REF                     = 0x03;
	mov	dptr,#_AX5043_REF
	mov	a,#0x03
	movx	@dptr,a
	C$config.c$165$1$85 ==.
;	..\AX_Radio_Lab_output\config.c:165: AX5043_0xF18                   = 0x06;
	mov	dptr,#_AX5043_0xF18
	mov	a,#0x06
	movx	@dptr,a
	C$config.c$166$1$85 ==.
...
;------------------------------------------------------------
	...
	C$config.c$172$1$85 ==.
;	..\AX_Radio_Lab_output\config.c:172: int32_t axradio_conv_freq_fromhz(int32_t f)
;	-----------------------------------------
...
_axradio_conv_freq_fromhz:
	...
	mov	r7,a
	C$config.c$179$1$87 ==.
;	..\AX_Radio_Lab_output\config.c:179: r = f;
	mov	ar0,r4
	mov	ar1,r5
	mov	ar2,r6
	mov	ar3,r7
	C$config.c$180$1$87 ==.
;	..\AX_Radio_Lab_output\config.c:180: f >>= 4;
	mov	a,r5
	swap	a
	xch	a,r4
	swap	a
...
00103$:
	mov	r7,a
	C$config.c$181$1$87 ==.
;	..\AX_Radio_Lab_output\config.c:181: r += f;
	mov	a,r4
	add	a,r0
	mov	r0,a
	mov	a,r5
	...
	mov	r3,a
	C$config.c$182$1$87 ==.
;	..\AX_Radio_Lab_output\config.c:182: f >>= 2;
	mov	a,r7
	mov	c,acc.7
	rrc	a
	mov	r7,a
	...
	mov	r4,a
	C$config.c$183$1$87 ==.
;	..\AX_Radio_Lab_output\config.c:183: r -= f;
	mov	a,r0
	clr	c
	subb	a,r4
	mov	r0,a
	...
	subb	a,r7
	C$config.c$184$1$87 ==.
;	..\AX_Radio_Lab_output\config.c:184: return r;
	mov	dpl,r0
	mov	dph,r1
	mov	b,r2
	C$config.c$185$1$87 ==.
...
;------------------------------------------------------------
	...
	C$config.c$190$1$87 ==.
;	..\AX_Radio_Lab_output\config.c:190: int32_t axradio_conv_freq_tohz(int32_t f)
;	-----------------------------------------
...
_axradio_conv_freq_tohz:
	...
	mov	r7,a
	C$config.c$197$1$89 ==.
;	..\AX_Radio_Lab_output\config.c:197: r = f;
	mov	ar0,r4
	mov	ar1,r5
	mov	ar2,r6
	mov	ar3,r7
	C$config.c$198$1$89 ==.
;	..\AX_Radio_Lab_output\config.c:198: f >>= 4;
	mov	a,r5
	swap	a
	xch	a,r4
	swap	a
...
00103$:
	mov	r7,a
	C$config.c$199$1$89 ==.
;	..\AX_Radio_Lab_output\config.c:199: r -= f;
	mov	a,r0
	clr	c
	subb	a,r4
	mov	r0,a
	...
	mov	r3,a
	C$config.c$200$1$89 ==.
;	..\AX_Radio_Lab_output\config.c:200: f >>= 2;
	mov	a,r7
	mov	c,acc.7
	rrc	a
	mov	r7,a
	...
	rrc	a
	C$config.c$201$1$89 ==.
;	..\AX_Radio_Lab_output\config.c:201: r += f;
	add	a,r0
	mov	r0,a
	mov	a,r5
	addc	a,r1
	...
	addc	a,r3
	C$config.c$202$1$89 ==.
;	..\AX_Radio_Lab_output\config.c:202: return r;
	mov	dpl,r0
	mov	dph,r1
	mov	b,r2
	C$config.c$203$1$89 ==.
...
;------------------------------------------------------------
	...
	C$config.c$208$1$89 ==.
;	..\AX_Radio_Lab_output\config.c:208: int32_t axradio_conv_timeinterval_totimer0(int32_t dt)
;	-----------------------------------------
...
_axradio_conv_timeinterval_totimer0:
	...
	mov	r7,a
	C$config.c$215$1$91 ==.
;	..\AX_Radio_Lab_output\config.c:215: dt >>= 5;
	mov	a,r5
	swap	a
	rr	a
	xch	a,r4
...
00103$:
	mov	r7,a
	C$config.c$216$1$91 ==.
;	..\AX_Radio_Lab_output\config.c:216: r = dt;
	mov	ar0,r4
	mov	ar1,r5
	mov	ar2,r6
	mov	ar3,r7
	C$config.c$217$1$91 ==.
;	..\AX_Radio_Lab_output\config.c:217: dt >>= 4;
	mov	a,r5
	swap	a
	xch	a,r4
	swap	a
...
00104$:
	mov	r7,a
	C$config.c$218$1$91 ==.
;	..\AX_Radio_Lab_output\config.c:218: r += dt;
	mov	a,r4
	add	a,r0
	mov	r0,a
	mov	a,r5
	...
	mov	r3,a
	C$config.c$219$1$91 ==.
;	..\AX_Radio_Lab_output\config.c:219: dt >>= 2;
	mov	a,r7
	mov	c,acc.7
	rrc	a
	mov	r7,a
	...
	mov	r4,a
	C$config.c$220$1$91 ==.
;	..\AX_Radio_Lab_output\config.c:220: r -= dt;
	mov	a,r0
	clr	c
	subb	a,r4
	mov	r0,a
	...
	mov	r3,a
	C$config.c$221$1$91 ==.
;	..\AX_Radio_Lab_output\config.c:221: dt >>= 3;
	mov	a,r5
	swap	a
	rl	a
	xch	a,r4
...
00105$:
	mov	r7,a
	C$config.c$222$1$91 ==.
;	..\AX_Radio_Lab_output\config.c:222: r += dt;
	mov	a,r4
	add	a,r0
	mov	r0,a
	mov	a,r5
	...
	addc	a,r3
	C$config.c$223$1$91 ==.
;	..\AX_Radio_Lab_output\config.c:223: return r;
	mov	dpl,r0
	mov	dph,r1
	mov	b,r2
	C$config.c$224$1$91 ==.
...
;------------------------------------------------------------
	...
	C$config.c$226$1$91 ==.
;	..\AX_Radio_Lab_output\config.c:226: __reentrantb uint8_t axradio_byteconv(uint8_t b) __reentrant
;	-----------------------------------------
;	 function axradio_byteconv
;	-----------------------------------------
_axradio_byteconv:
	C$config.c$228$1$93 ==.
;	..\AX_Radio_Lab_output\config.c:228: return b;
	C$config.c$229$1$93 ==.
...
;------------------------------------------------------------
	...
	C$config.c$232$1$93 ==.
;	..\AX_Radio_Lab_output\config.c:232: __reentrantb void axradio_byteconv_buffer(uint8_t __xdata *buf, uint16_t buflen) __reentrant
;	-----------------------------------------
...
_axradio_byteconv_buffer:
	...
	mov	_bp,sp
	C$config.c$234$1$93 ==.
;	..\AX_Radio_Lab_output\config.c:234: }
	pop	_bp
	C$config.c$234$1$93 ==.
...
;------------------------------------------------------------
	...
	C$config.c$237$1$93 ==.
;	..\AX_Radio_Lab_output\config.c:237: __reentrantb uint8_t axradio_framing_check_crc(const __xdata uint8_t *pkt, uint16_t cnt) __reentrant
;	-----------------------------------------
...
_axradio_framing_check_crc:
	...
	mov	r7,dph
	C$config.c$239$1$97 ==.
;	..\AX_Radio_Lab_output\config.c:239: return crc_crc16(pkt, cnt, 0xFFFF) == 0xB001;
	mov	r5,#0x00
	mov	a,#0xFF
	push	acc
	push	acc
...
;------------------------------------------------------------
	...
	C$config.c$243$1$97 ==.
;	..\AX_Radio_Lab_output\config.c:243: __reentrantb uint16_t axradio_framing_append_crc(__xdata uint8_t *pkt, uint16_t cnt) __reentrant
;	-----------------------------------------
...
_axradio_framing_append_crc:
	...
	mov	r7,dph
	C$config.c$245$1$99 ==.
;	..\AX_Radio_Lab_output\config.c:245: uint16_t s = crc_crc16(pkt, cnt, 0xFFFF);
	mov	ar3,r6
	mov	ar4,r7
	mov	r5,#0x00
	push	ar7
	...
	pop	ar7
	C$config.c$246$1$99 ==.
;	..\AX_Radio_Lab_output\config.c:246: pkt += cnt;
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	...
	mov	r7,a
	C$config.c$247$1$99 ==.
;	..\AX_Radio_Lab_output\config.c:247: *pkt++ = ~(uint8_t)(s);
	mov	ar3,r4
	mov	a,r3
	cpl	a
	mov	dpl,r6
	...
	mov	r7,dph
	C$config.c$248$1$99 ==.
;	..\AX_Radio_Lab_output\config.c:248: *pkt++ = ~(uint8_t)(s >> 8);
	mov	ar4,r5
	mov	a,r4
	cpl	a
	mov	dpl,r6
	...
	movx	@dptr,a
	C$config.c$249$1$99 ==.
;	..\AX_Radio_Lab_output\config.c:249: return cnt + 2;
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	dpl,@r0
...
_axradio_sync_slave_rxadvance:
	.byte #0x29,#0x07,#0x00,#0x00	; 1833
	.byte #0x04,#0x07,#0x00,#0x00	; 1796
	.byte #0x52,#0x07,#0x00,#0x00	; 1874
G$axradio_sync_slave_rxwindow$0$0 == .
_axradio_sync_slave_rxwindow:
	.byte #0x37,#0x07,#0x00,#0x00	; 1847
	.byte #0xED,#0x06,#0x00,#0x00	; 1773
	.byte #0x89,#0x07,#0x00,#0x00	; 1929
G$axradio_sync_slave_rxtimeout$0$0 == .
_axradio_sync_slave_rxtimeout:
	.byte #0x97,#0x08,#0x00,#0x00	; 2199
	.area XINIT   (CODE)
	.area CABS    (ABS,CODE)
