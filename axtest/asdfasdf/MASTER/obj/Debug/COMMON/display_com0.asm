...
; This file was generated Sat Dec 21 22:02:04 2013
;--------------------------------------------------------
	.module display_com0
...
;	..\COMMON\display_com0.c:27: uart_timer0_baud(CLKSRC_SYSCLK, 115200, 20000000UL);
	...
	mov	(_uart_timer0_baud_PARM_2 + 2),#0x01
	mov	(_uart_timer0_baud_PARM_2 + 3),a
	mov	_uart_timer0_baud_PARM_3,#0x00
	mov	(_uart_timer0_baud_PARM_3 + 1),#0x2D
	mov	(_uart_timer0_baud_PARM_3 + 2),#0x31
	mov	(_uart_timer0_baud_PARM_3 + 3),#0x01
	mov	dpl,#0x06
...
00106$:
	pop	_bp
	C$display_com0.c$96$1$188 ==.
	XG$com0_clear$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
Fdisplay_com0$_str_0$0$0 == .
__str_0:
	.db 0x1B
	.ascii "[0;8;44;30m"
	.db 0x1B
