...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	AX5043_TMGRXOFFSACQ            = 0x9C;
	AX5043_TMGRXCOARSEAGC          = 0x32;
...
#endif
{
	/* scale by 0.343750 (true 0.349525) */
	int32_t r;
	f >>= 1;
	r = f;
	f >>= 2;
...
#endif
{
	/* scale by 2.875000 (true 2.861023) */
	int32_t r;
	r = -f;
	f <<= 2;
	r += f;
...
const int32_t __code axradio_phy_maxfreqoffset = 1821;
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 850, 813, 891 };// 25.915ms, 24.785ms, 27.164ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 864, 790, 946 }; // 26.343ms, 24.083ms, 28.841ms
