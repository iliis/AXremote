M:lposc
F:Flposc$wait_n_lposccycles$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$calibrate_lposc$0$0({2}DF,SV:S),Z,0,0,0,0,0
T:Flposc$axradio_status_receive[({0}S:S$phy$0$0({10}STaxradio_status_receive_phy:S),Z,0,0)({10}S:S$mac$0$0({10}STaxradio_status_receive_mac:S),Z,0,0)({20}S:S$pktdata$0$0({2}DX,SC:U),Z,0,0)({22}S:S$pktlen$0$0({2}SI:U),Z,0,0)]
T:Flposc$axradio_address[({0}S:S$addr$0$0({4}DA4d,SC:U),Z,0,0)]
T:Flposc$axradio_address_mask[({0}S:S$addr$0$0({4}DA4d,SC:U),Z,0,0)({4}S:S$mask$0$0({4}DA4d,SC:U),Z,0,0)]
T:Flposc$__00000000[({0}S:S$rx$0$0({24}STaxradio_status_receive:S),Z,0,0)({0}S:S$cs$0$0({3}STaxradio_status_channelstate:S),Z,0,0)]
T:Flposc$axradio_status_channelstate[({0}S:S$rssi$0$0({2}SI:S),Z,0,0)({2}S:S$busy$0$0({1}SC:U),Z,0,0)]
T:Flposc$u32endian[({0}S:S$b0$0$0({1}SC:U),Z,0,0)({1}S:S$b1$0$0({1}SC:U),Z,0,0)({2}S:S$b2$0$0({1}SC:U),Z,0,0)({3}S:S$b3$0$0({1}SC:U),Z,0,0)]
T:Flposc$u16endian[({0}S:S$b0$0$0({1}SC:U),Z,0,0)({1}S:S$b1$0$0({1}SC:U),Z,0,0)]
T:Flposc$axradio_status_receive_mac[({0}S:S$remoteaddr$0$0({4}DA4d,SC:U),Z,0,0)({4}S:S$localaddr$0$0({4}DA4d,SC:U),Z,0,0)({8}S:S$raw$0$0({2}DX,SC:U),Z,0,0)]
T:Flposc$axradio_status_receive_phy[({0}S:S$rssi$0$0({2}SI:S),Z,0,0)({2}S:S$offset$0$0({4}SL:S),Z,0,0)({6}S:S$timeoffset$0$0({2}SI:S),Z,0,0)({8}S:S$period$0$0({2}SI:S),Z,0,0)]
T:Flposc$axradio_status[({0}S:S$status$0$0({1}SC:U),Z,0,0)({1}S:S$error$0$0({1}SC:U),Z,0,0)({2}S:S$time$0$0({4}SL:U),Z,0,0)({6}S:S$u$0$0({24}ST__00000000:S),Z,0,0)]
...
S:Llposc.wait_n_lposccycles$n$1$63({1}SC:U),R,0,0,[r7]
S:Llposc.wait_n_lposccycles$cnt$1$64({1}SC:U),R,0,0,[r6]
S:Llposc.calibrate_lposc$x$2$71({1}SC:U),R,0,0,[r7]
...
S:Flposc$wait_n_lposccycles$0$0({2}DF,SV:S),C,0,0
