M:display
F:G$display_received_packet$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:Fdisplay$wait_dbglink_free$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$dbglink_received_packet$0$0({2}DF,SV:S),Z,0,0,0,0,0
T:Fdisplay$wtimer_callback[({0}S:S$next$0$0({2}DX,STwtimer_callback:S),Z,0,0)({2}S:S$handler$0$0({2}DC,DF,SV:S),Z,0,0)]
T:Fdisplay$axradio_status_receive[({0}S:S$phy$0$0({10}STaxradio_status_receive_phy:S),Z,0,0)({10}S:S$mac$0$0({10}STaxradio_status_receive_mac:S),Z,0,0)({20}S:S$pktdata$0$0({2}DX,SC:U),Z,0,0)({22}S:S$pktlen$0$0({2}SI:U),Z,0,0)]
T:Fdisplay$axradio_address[({0}S:S$addr$0$0({4}DA4d,SC:U),Z,0,0)]
T:Fdisplay$axradio_address_mask[({0}S:S$addr$0$0({4}DA4d,SC:U),Z,0,0)({4}S:S$mask$0$0({4}DA4d,SC:U),Z,0,0)]
T:Fdisplay$__00000000[({0}S:S$rx$0$0({24}STaxradio_status_receive:S),Z,0,0)({0}S:S$cs$0$0({3}STaxradio_status_channelstate:S),Z,0,0)]
T:Fdisplay$axradio_status_channelstate[({0}S:S$rssi$0$0({2}SI:S),Z,0,0)({2}S:S$busy$0$0({1}SC:U),Z,0,0)]
T:Fdisplay$wtimer_desc[({0}S:S$next$0$0({2}DX,STwtimer_desc:S),Z,0,0)({2}S:S$handler$0$0({2}DC,DF,SV:S),Z,0,0)({4}S:S$time$0$0({4}SL:U),Z,0,0)]
T:Fdisplay$axradio_status_receive_mac[({0}S:S$remoteaddr$0$0({4}DA4d,SC:U),Z,0,0)({4}S:S$localaddr$0$0({4}DA4d,SC:U),Z,0,0)({8}S:S$raw$0$0({2}DX,SC:U),Z,0,0)]
T:Fdisplay$calsector[({0}S:S$id$0$0({5}DA5d,SC:U),Z,0,0)({5}S:S$len$0$0({1}SC:U),Z,0,0)({6}S:S$devid$0$0({6}DA6d,SC:U),Z,0,0)({12}S:S$calg00gain$0$0({2}DA2d,SC:U),Z,0,0)({14}S:S$calg01gain$0$0({2}DA2d,SC:U),Z,0,0)({16}S:S$calg10gain$0$0({2}DA2d,SC:U),Z,0,0)({18}S:S$caltempgain$0$0({2}DA2d,SC:U),Z,0,0)({20}S:S$caltempoffs$0$0({2}DA2d,SC:U),Z,0,0)({22}S:S$frcoscfreq$0$0({2}DA2d,SC:U),Z,0,0)({24}S:S$lposcfreq$0$0({2}DA2d,SC:U),Z,0,0)({26}S:S$lposcfreq_fast$0$0({2}DA2d,SC:U),Z,0,0)({28}S:S$powctrl0$0$0({1}SC:U),Z,0,0)({29}S:S$powctrl1$0$0({1}SC:U),Z,0,0)({30}S:S$ref$0$0({1}SC:U),Z,0,0)]
T:Fdisplay$axradio_status_receive_phy[({0}S:S$rssi$0$0({2}SI:S),Z,0,0)({2}S:S$offset$0$0({4}SL:S),Z,0,0)({6}S:S$timeoffset$0$0({2}SI:S),Z,0,0)({8}S:S$period$0$0({2}SI:S),Z,0,0)]
T:Fdisplay$axradio_status[({0}S:S$status$0$0({1}SC:U),Z,0,0)({1}S:S$error$0$0({1}SC:U),Z,0,0)({2}S:S$time$0$0({4}SL:U),Z,0,0)({6}S:S$u$0$0({24}ST__00000000:S),Z,0,0)]
S:G$random_seed$0$0({2}SI:U),E,0,0
S:G$per_test_counter$0$0({2}SI:U),E,0,0
S:G$per_test_counter_previous$0$0({2}SI:U),E,0,0
S:G$pkts_received$0$0({2}SI:U),E,0,0
S:G$pkts_missing$0$0({2}SI:U),E,0,0
S:G$display_timing$0$0({1}SC:U),E,0,0
S:Fdisplay$dbglink_semaphore$0$0({1}SC:U),E,0,0
S:Ldisplay.dbglink_received_packet$st$1$239({2}DX,STaxradio_status:S),R,0,0,[r6,r7]
S:Ldisplay.dbglink_received_packet$pktlen$1$240({2}SI:U),R,0,0,[r4,r5]
S:Ldisplay.dbglink_received_packet$i$2$242({2}SI:U),R,0,0,[r2,r3]
S:Ldisplay.dbglink_received_packet$pktdata$2$242({2}DX,SC:U),R,0,0,[r6,r7]
...
S:Fdisplay$flash_deviceid$0$0({6}DA6d,SC:U),F,0,0
S:Fdisplay$flash_calsector$0$0({31}STcalsector:S),F,0,0
...
S:Fdisplay$wait_dbglink_free$0$0({2}DF,SV:S),C,0,0
...
S:Fdisplay$_str_0$0$0({12}DA12d,SC:S),D,0,0
S:Fdisplay$_str_1$0$0({9}DA9d,SC:S),D,0,0
S:Fdisplay$_str_2$0$0({7}DA7d,SC:S),D,0,0
S:Fdisplay$_str_3$0$0({14}DA14d,SC:S),D,0,0
S:Fdisplay$_str_4$0$0({4}DA4d,SC:S),D,0,0
S:Fdisplay$_str_5$0$0({3}DA3d,SC:S),D,0,0
S:Fdisplay$_str_6$0$0({3}DA3d,SC:S),D,0,0
S:Fdisplay$_str_7$0$0({3}DA3d,SC:S),D,0,0
