                              ...
                              4 ; This file was generated Sat Dec 21 22:01:15 2013
                              5 ;--------------------------------------------------------
   ...
   06ED 90 70 09           3189 	mov	dptr,#_PALTB
   06F0 E0                 3190 	movx	a,@dptr
   06F1 44 11              3191 	orl	a,#0x11
   06F3 F0                 3192 	movx	@dptr,a
                    0007   3193 	C$display_com0.c$23$1$173 ==.
                           3194 ;	..\COMMON\display_com0.c:23: DIRB |= (1<<0) | (1<<4);
   06F4 43 8A 11           3195 	orl	_DIRB,#0x11
                    000A   3196 	C$display_com0.c$24$1$173 ==.
                           3197 ;	..\COMMON\display_com0.c:24: DIRB &= (uint8_t)~(1<<5);
   06F7 53 8A DF           3198 	anl	_DIRB,#0xDF
                    000D   3199 	C$display_com0.c$25$1$173 ==.
                           3200 ;	..\COMMON\display_com0.c:25: PINSEL &= (uint8_t)~((1<<0) | (1<<1));
   06FA 90 70 0B           3201 	mov	dptr,#_PINSEL
   06FD E0                 3202 	movx	a,@dptr
   06FE 54 FC              3203 	anl	a,#0xFC
   0700 F0                 3204 	movx	@dptr,a
                    0014   3205 	C$display_com0.c$27$1$173 ==.
                           3206 ;	..\COMMON\display_com0.c:27: uart_timer0_baud(CLKSRC_SYSCLK, 115200, 20000000UL);
   0701 E4                 3207 	clr	a
   0702 F5 17              3208 	mov	_uart_timer0_baud_PARM_2,a
   0704 75 18 C2           3209 	mov	(_uart_timer0_baud_PARM_2 + 1),#0xC2
   0707 75 19 01           3210 	mov	(_uart_timer0_baud_PARM_2 + 2),#0x01
   070A F5 1A              3211 	mov	(_uart_timer0_baud_PARM_2 + 3),a
   070C 75 1B 00           3212 	mov	_uart_timer0_baud_PARM_3,#0x00
   070F 75 1C 2D           3213 	mov	(_uart_timer0_baud_PARM_3 + 1),#0x2D
   ...
   072A 22                 3226 	ret
                    ...
                    003E   3231 	C$display_com0.c$31$1$173 ==.
                           ...
                           3235 ;	-----------------------------------------
   072B                    3236 _com0_init:
                    003E   3237 	C$display_com0.c$33$1$175 ==.
                           3238 ;	..\COMMON\display_com0.c:33: uart_timer0_baud(CLKSRC_SYSCLK, 115200, 20000000UL);
   072B E4                 3239 	clr	a
   072C F5 17              3240 	mov	_uart_timer0_baud_PARM_2,a
   072E 75 18 C2           3241 	mov	(_uart_timer0_baud_PARM_2 + 1),#0xC2
   0731 75 19 01           3242 	mov	(_uart_timer0_baud_PARM_2 + 2),#0x01
   0734 F5 1A              3243 	mov	(_uart_timer0_baud_PARM_2 + 3),a
   0736 75 1B 00           3244 	mov	_uart_timer0_baud_PARM_3,#0x00
   0739 75 1C 2D           3245 	mov	(_uart_timer0_baud_PARM_3 + 1),#0x2D
   ...
   0756 AE 09              3259 	mov	r6,(_lcd_border + 1)
   0758 7F 80              3260 	mov	r7,#0x80
   075A 8D 82              3261 	mov	dpl,r5
   075C 8E 83              3262 	mov	dph,r6
   075E 8F F0              3263 	mov	b,r7
   0760 12 07 E7           3264 	lcall	_com0_writestr
                    0076   3265 	C$display_com0.c$37$1$175 ==.
                           3266 ;	..\COMMON\display_com0.c:37: com0_setpos(0);
   0763 75 82 00           3267 	mov	dpl,#0x00
   0766 12 07 A4           3268 	lcall	_com0_setpos
   ...
   076D 22                 3289 	ret
                    ...
                    0081   3294 	C$display_com0.c$45$1$177 ==.
                           ...
                           3298 ;	-----------------------------------------
   076E                    3299 _com0_newline:
                    0081   3300 	C$display_com0.c$47$1$179 ==.
                           3301 ;	..\COMMON\display_com0.c:47: if (row < 3)
   076E 90 00 02           3302 	mov	dptr,#_row
   0771 E0                 3303 	movx	a,@dptr
   0772 FF                 3304 	mov	r7,a
   0773 BF 03 00           3305 	cjne	r7,#0x03,00107$
   0776                    3306 00107$:
   0776 50 06              3307 	jnc	00102$
                    008B   3308 	C$display_com0.c$48$1$179 ==.
                           3309 ;	..\COMMON\display_com0.c:48: ++row;
   0778 90 00 02           3310 	mov	dptr,#_row
   077B EF                 3311 	mov	a,r7
   077C 04                 3312 	inc	a
   077D F0                 3313 	movx	@dptr,a
   077E                    3314 00102$:
                    0091   3315 	C$display_com0.c$49$1$179 ==.
                           3316 ;	..\COMMON\display_com0.c:49: column = 2;
   077E 90 00 03           3317 	mov	dptr,#_column
   0781 74 02              3318 	mov	a,#0x02
   0783 F0                 3319 	movx	@dptr,a
                    0097   3320 	C$display_com0.c$50$1$179 ==.
                           3321 ;	..\COMMON\display_com0.c:50: cmd[2] = row + '0';
   0784 90 00 02           3322 	mov	dptr,#_row
   0787 E0                 3323 	movx	a,@dptr
   0788 24 30              3324 	add	a,#0x30
   078A 90 04 2D           3325 	mov	dptr,#(_cmd + 0x0002)
   078D F0                 3326 	movx	@dptr,a
                    00A1   3327 	C$display_com0.c$51$1$179 ==.
                           3328 ;	..\COMMON\display_com0.c:51: cmd[4] = '0';
   078E 90 04 2F           3329 	mov	dptr,#(_cmd + 0x0004)
   0791 74 30              3330 	mov	a,#0x30
   0793 F0                 3331 	movx	@dptr,a
                    00A7   3332 	C$display_com0.c$52$1$179 ==.
                           3333 ;	..\COMMON\display_com0.c:52: cmd[5] = '2';
   0794 90 04 30           3334 	mov	dptr,#(_cmd + 0x0005)
   0797 74 32              3335 	mov	a,#0x32
   0799 F0                 3336 	movx	@dptr,a
   ...
   07A3 22                 3344 	ret
                    ...
                    00B7   3351 	C$display_com0.c$56$1$179 ==.
                           ...
                           3355 ;	-----------------------------------------
   07A4                    3356 _com0_setpos:
                    00B7   3357 	C$display_com0.c$60$1$181 ==.
                           3358 ;	..\COMMON\display_com0.c:60: row = (v >> 6) + 2;
   07A4 E5 82              3359 	mov	a,dpl
   07A6 FF                 3360 	mov	r7,a
   07A7 23                 3361 	rl	a
   07A8 23                 3362 	rl	a
   07A9 54 03              3363 	anl	a,#0x03
   07AB FE                 3364 	mov	r6,a
   07AC 0E                 3365 	inc	r6
   07AD 0E                 3366 	inc	r6
   07AE 90 00 02           3367 	mov	dptr,#_row
   07B1 EE                 3368 	mov	a,r6
   07B2 F0                 3369 	movx	@dptr,a
                    00C6   3370 	C$display_com0.c$61$1$181 ==.
                           3371 ;	..\COMMON\display_com0.c:61: column = (v & 0x3F) + 2;
   07B3 74 3F              3372 	mov	a,#0x3F
   07B5 5F                 3373 	anl	a,r7
   07B6 24 02              3374 	add	a,#0x02
   07B8 FF                 3375 	mov	r7,a
   07B9 90 00 03           3376 	mov	dptr,#_column
   07BC F0                 3377 	movx	@dptr,a
                    00D0   3378 	C$display_com0.c$62$1$181 ==.
                           3379 ;	..\COMMON\display_com0.c:62: cmd[2] = row + '0';
   07BD 74 30              3380 	mov	a,#0x30
   07BF 2E                 3381 	add	a,r6
   07C0 90 04 2D           3382 	mov	dptr,#(_cmd + 0x0002)
   07C3 F0                 3383 	movx	@dptr,a
                    00D7   3384 	C$display_com0.c$63$1$181 ==.
                           3385 ;	..\COMMON\display_com0.c:63: cmd[4] = column / 10 + '0';
   07C4 75 F0 0A           3386 	mov	b,#0x0A
   07C7 EF                 3387 	mov	a,r7
   07C8 84                 3388 	div	ab
   07C9 24 30              3389 	add	a,#0x30
   07CB 90 04 2F           3390 	mov	dptr,#(_cmd + 0x0004)
   07CE F0                 3391 	movx	@dptr,a
                    00E2   3392 	C$display_com0.c$64$1$181 ==.
                           3393 ;	..\COMMON\display_com0.c:64: cmd[5] = column % 10 + '0';
   07CF 75 F0 0A           3394 	mov	b,#0x0A
   07D2 EF                 3395 	mov	a,r7
   07D3 84                 3396 	div	ab
   07D4 AF F0              3397 	mov	r7,b
   07D6 74 30              3398 	mov	a,#0x30
   07D8 2F                 3399 	add	a,r7
   07D9 90 04 30           3400 	mov	dptr,#(_cmd + 0x0005)
   07DC F0                 3401 	movx	@dptr,a
   ...
   07E6 22                 3409 	ret
                    ...
                    00FA   3417 	C$display_com0.c$68$1$181 ==.
                           ...
                           3421 ;	-----------------------------------------
   07E7                    3422 _com0_writestr:
   07E7 AD 82              3423 	mov	r5,dpl
   07E9 AE 83              3424 	mov	r6,dph
   07EB AF F0              3425 	mov	r7,b
   07ED                    3426 00104$:
   ...
   07F7 60 18              3436 	jz	00106$
                    010C   3437 	C$display_com0.c$74$2$184 ==.
                           3438 ;	..\COMMON\display_com0.c:74: com0_tx(ch);
   07F9 8C 82              3439 	mov	dpl,r4
   07FB C0 07              3440 	push	ar7
   07FD C0 06              3441 	push	ar6
   07FF C0 05              3442 	push	ar5
   0801 12 08 12           3443 	lcall	_com0_tx
   0804 D0 05              3444 	pop	ar5
   0806 D0 06              3445 	pop	ar6
   0808 D0 07              3446 	pop	ar7
                    011D   3447 	C$display_com0.c$75$2$184 ==.
                           3448 ;	..\COMMON\display_com0.c:75: msg++;
   080A 0D                 3449 	inc	r5
   080B BD 00 DF           3450 	cjne	r5,#0x00,00104$
   080E 0E                 3451 	inc	r6
   080F 80 DC              3452 	sjmp	00104$
   0811                    3453 00106$:
   ...
   0821 22                 3485 	ret
                    ...
                    0135   3493 	C$display_com0.c$88$1$186 ==.
                           ...
                           3497 ;	-----------------------------------------
   0822                    3498 _com0_clear:
   0822 C0 1F              3499 	push	_bp
   0824 85 81 1F           3500 	mov	_bp,sp
                    013A   3501 	C$display_com0.c$90$1$188 ==.
                           3502 ;	..\COMMON\display_com0.c:90: com0_setpos(pos);
   0827 12 07 A4           3503 	lcall	_com0_setpos
                    013D   3504 	C$display_com0.c$91$1$188 ==.
                           3505 ;	..\COMMON\display_com0.c:91: if (!len)
   082A E5 1F              3506 	mov	a,_bp
   082C 24 FD              3507 	add	a,#0xfd
   082E F8                 3508 	mov	r0,a
   082F E6                 3509 	mov	a,@r0
   0830 70 02              3510 	jnz	00109$
   ...
   0832 80 13              3515 	sjmp	00106$
   0834                    3516 00109$:
   0834 E5 1F              3517 	mov	a,_bp
   0836 24 FD              3518 	add	a,#0xfd
   0838 F8                 3519 	mov	r0,a
   0839 86 07              3520 	mov	ar7,@r0
   083B                    3521 00103$:
                    014E   3522 	C$display_com0.c$94$2$189 ==.
                           3523 ;	..\COMMON\display_com0.c:94: com0_tx(' ');
   083B 75 82 20           3524 	mov	dpl,#0x20
   083E C0 07              3525 	push	ar7
   0840 12 08 12           3526 	lcall	_com0_tx
   0843 D0 07              3527 	pop	ar7
                    0158   3528 	C$display_com0.c$95$1$188 ==.
                           3529 ;	..\COMMON\display_com0.c:95: } while (--len);
   0845 DF F4              3530 	djnz	r7,00103$
   0847                    3531 00106$:
   0847 D0 1F              3532 	pop	_bp
