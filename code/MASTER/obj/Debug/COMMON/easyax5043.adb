...
S:Leasyax5043.update_timeanchor$iesave$1$203({1}SC:U),R,0,0,[r7]
F:G$axradio_conv_time_totimer0$0$0({2}DF,SL:U),Z,0,0,0,0,0
S:Leasyax5043.axradio_conv_time_totimer0$dt$1$204({4}SL:U),R,0,0,[r4,r5,r6,r7]
F:G$ax5043_init_registers_tx$0$0({2}DF,SC:U),C,0,0,0,0,0
S:Leasyax5043.ax5043_init_registers_tx$rng$1$207({1}SC:U),R,0,0,[r7]
F:G$ax5043_init_registers_rx$0$0({2}DF,SC:U),C,0,0,0,0,0
S:Leasyax5043.ax5043_init_registers_rx$rng$1$211({1}SC:U),R,0,0,[r7]
F:Feasyax5043$receive_isr$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Leasyax5043.receive_isr$fifo_cmd$1$215({1}SC:U),R,0,0,[r6]
S:Leasyax5043.receive_isr$flags$1$215({1}SC:U),R,0,0,[]
S:Leasyax5043.receive_isr$i$1$215({1}SC:U),R,0,0,[r6]
S:Leasyax5043.receive_isr$len$1$215({1}SC:U),R,0,0,[r7]
S:Leasyax5043.receive_isr$r$5$222({1}SC:S),R,0,0,[r6]
S:Leasyax5043.receive_isr$r$4$225({1}SC:S),R,0,0,[r6]
S:Leasyax5043.receive_isr$r$4$226({1}SC:S),R,0,0,[r6]
F:Feasyax5043$transmit_isr$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Leasyax5043.transmit_isr$cnt$2$230({1}SC:U),R,0,0,[r7]
S:Leasyax5043.transmit_isr$byte$5$234({1}SC:U),R,0,0,[r7]
S:Leasyax5043.transmit_isr$len_byte$5$237({1}SC:U),R,0,0,[r4]
S:Leasyax5043.transmit_isr$i$5$237({1}SC:U),R,0,0,[r3]
S:Leasyax5043.transmit_isr$byte$4$240({1}SC:U),R,0,0,[r6]
S:Leasyax5043.transmit_isr$flags$4$243({1}SC:U),R,0,0,[r6]
S:Leasyax5043.transmit_isr$len$5$244({2}SI:U),R,0,0,[r4,r5]
F:G$axradio_isr$0$0({2}DF,SV:S),Z,0,0,1,4,0
F:G$ax5043_receiver_on_continuous$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Leasyax5043.ax5043_receiver_on_continuous$rschanged_int$1$263({1}SC:U),R,0,0,[r7]
F:G$ax5043_receiver_on_wor$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Leasyax5043.ax5043_receiver_on_wor$wp$2$268({2}SI:U),R,0,0,[r6,r7]
...
S:Leasyax5043.axradio_sync_addtime$dt$1$283({4}SL:U),R,0,0,[r4,r5,r6,r7]
F:Feasyax5043$axradio_sync_subtime$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Leasyax5043.axradio_sync_subtime$dt$1$285({4}SL:U),R,0,0,[r4,r5,r6,r7]
F:Feasyax5043$axradio_sync_settimeradv$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Leasyax5043.axradio_sync_settimeradv$dt$1$287({4}SL:U),R,0,0,[r4,r5,r6,r7]
...
S:Leasyax5043.axradio_callback_fwd$desc$1$310({2}DX,STwtimer_callback:S),R,0,0,[r6,r7]
...
F:G$axradio_get_pllrange_tx$0$0({2}DF,SC:U),Z,0,0,0,0,0
...
S:Leasyax5043.axradio_set_paramsets$val$1$406({1}SC:U),R,0,0,[r7]
...
S:Leasyax5043.axradio_isr$evt$3$256({1}SC:U),R,0,0,[r7]
S:Leasyax5043.axradio_wait_for_xtal$iesave$1$276({1}SC:U),R,0,0,[r7]
S:Leasyax5043.axradio_setaddrregs$pn$2$280({2}SI:U),R,0,0,[r6,r7]
S:Leasyax5043.axradio_setaddrregs$inv$2$280({1}SC:U),R,0,0,[r5]
S:Leasyax5043.axradio_sync_adjustperiodcorr$dt$1$290({4}SL:S),R,0,0,[r4,r5,r6,r7]
S:Leasyax5043.axradio_sync_slave_nextperiod$c$2$294({2}SI:S),R,0,0,[r6,r7]
S:Leasyax5043.axradio_timer_callback$desc$1$295({2}DX,STwtimer_desc:S),R,0,0,[]
S:Leasyax5043.axradio_timer_callback$r$3$298({1}SC:S),R,0,0,[r7]
S:Leasyax5043.axradio_timer_callback$idx$4$306({1}SC:U),R,0,0,[r7]
S:Leasyax5043.axradio_timer_callback$idx$5$309({1}SC:U),R,0,0,[r7]
S:Leasyax5043.axradio_receive_callback_fwd$desc$1$312({2}DX,STwtimer_callback:S),R,0,0,[]
S:Leasyax5043.axradio_receive_callback_fwd$len$2$315({2}SI:U),R,0,0,[r6,r7]
S:Leasyax5043.axradio_receive_callback_fwd$len$2$316({2}SI:U),R,0,0,[r6,r7]
S:Leasyax5043.axradio_receive_callback_fwd$seqnr$3$321({1}SC:U),R,0,0,[r6]
S:Leasyax5043.axradio_receive_callback_fwd$len_byte$3$323({1}SC:U),R,0,0,[r6]
S:Leasyax5043.axradio_receive_callback_fwd$trxst$2$331({1}SC:U),R,0,0,[r6]
S:Leasyax5043.axradio_receive_callback_fwd$iesave$3$332({1}SC:U),R,0,0,[r7]
S:Leasyax5043.axradio_init$i$1$339({1}SC:U),R,0,0,[r5]
S:Leasyax5043.axradio_init$pllloop_save$1$339({1}SC:U),R,0,0,[r7]
S:Leasyax5043.axradio_init$pllcpi_save$1$339({1}SC:U),R,0,0,[r6]
S:Leasyax5043.axradio_init$iesave$2$340({1}SC:U),R,0,0,[r4]
S:Leasyax5043.axradio_init$f$3$341({4}SL:U),R,0,0,[r1,r2,r3,r4]
S:Leasyax5043.axradio_init$r$3$342({1}SC:U),R,0,0,[r3]
S:Leasyax5043.axradio_init$iesave$2$347({1}SC:U),R,0,0,[r4]
S:Leasyax5043.axradio_init$r$3$348({1}SC:U),R,0,0,[r3]
S:Leasyax5043.axradio_init$f$2$352({4}SL:U),R,0,0,[r2,r3,r4,r5]
S:Leasyax5043.axradio_set_mode$mode$1$357({1}SC:U),R,0,0,[r7]
S:Leasyax5043.axradio_set_mode$r$3$360({1}SC:U),R,0,0,[r6]
S:Leasyax5043.axradio_set_mode$r$3$361({1}SC:U),R,0,0,[r6]
S:Leasyax5043.axradio_set_mode$iesave$3$362({1}SC:U),R,0,0,[r6]
S:Leasyax5043.axradio_set_curfreqoffset$offs$1$380({4}SL:S),R,0,0,[r4,r5,r6,r7]
S:Leasyax5043.axradio_set_freqoffset$offs$1$382({4}SL:S),R,0,0,[r4,r5,r6,r7]
S:Leasyax5043.axradio_set_freqoffset$ret$1$383({1}SC:U),R,0,0,[r7]
S:Leasyax5043.axradio_set_freqoffset$ret2$2$384({1}SC:U),R,0,0,[r6]
S:Leasyax5043.axradio_set_local_address$addr$1$387({3}DG,STaxradio_address_mask:S),R,0,0,[r5,r6,r7]
S:Leasyax5043.axradio_get_local_address$addr$1$389({3}DG,STaxradio_address_mask:S),R,0,0,[r5,r6,r7]
S:Leasyax5043.axradio_set_default_remote_address$addr$1$391({3}DG,STaxradio_address:S),R,0,0,[r5,r6,r7]
S:Leasyax5043.axradio_get_default_remote_address$addr$1$393({3}DG,STaxradio_address:S),R,0,0,[r5,r6,r7]
S:Leasyax5043.axradio_transmit$pkt$1$395({3}DG,SC:U),E,0,0
S:Leasyax5043.axradio_transmit$pktlen$1$395({2}SI:U),E,0,0
S:Leasyax5043.axradio_transmit$addr$1$395({3}DG,STaxradio_address:S),R,0,0,[r5,r6,r7]
S:Leasyax5043.axradio_transmit$fifofree$3$398({2}SI:U),R,0,0,[r3,r4]
S:Leasyax5043.axradio_transmit$i$3$399({1}SC:U),R,0,0,[r4]
S:Leasyax5043.axradio_transmit$iesave$3$401({1}SC:U),R,0,0,[r4]
S:Leasyax5043.axradio_transmit$len_byte$3$402({1}SC:U),R,0,0,[r6]
...
S:G$AX5043_0xF01$0$0({1}SC:U),F,0,0
...
S:G$AX5043_0xF2F$0$0({1}SC:U),F,0,0
...
S:G$axradio_phy_chanpllrng_rx$0$0({0}DA0d,SC:U),F,0,0
S:G$axradio_phy_chanpllrng_tx$0$0({0}DA0d,SC:U),F,0,0
...
S:G$axradio_framing_check_crc$0$0({2}DF,SC:U),C,0,0
...
S:G$axradio_phy_tmgrxpreamble1_wor$0$0({1}SC:U),D,0,0
S:G$axradio_phy_tmgrxpreamble1_cont$0$0({1}SC:U),D,0,0
